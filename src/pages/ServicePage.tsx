...
export const ServicePage = () => {
  return (
    <>
      <Helmet>
        <title>Our Service: Benargy Engineering Solutions</title>
        <meta
          name="description"
          content="We are committed to providing top-notch solutions for your home
        ...
        <meta
          property="og:title"
          content="Services: Benargy Engineering Solutions"
        />
      </Helmet>
      <section>
        <section
