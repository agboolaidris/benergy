        ...
        <Wrapper className="relative aspect-video flex items-center ">
          <div className="max-w-5xl">
            ...
            <SubTitle className="!text-white !font-medium mt-4 sm:mt-8">
              ...
              engineering solutions to empower to empower homes, businesses and
              industries
            </SubTitle>
          </div>
        </Wrapper>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-8 lg:gap-32">
            ...
            <div className="lg:col-span-3 ">
              ...
              <div className="mt-3 space-y-2 sm:mt-10 sm:space-y-5">
                <BodyText>
                  At Benargy Engineering Solutions, we’re shaping the future—one
                  smart solution at a time. As a forward-thinking engineering
                  company, we specialize in renewable energy, smart home
                  automation, security systems and surveillance, and
                  comprehensive electrical installations. Our desire is to
                ...
                <BodyText>
                  ...
                  installing cutting-edge solar systems, designing custom smart
                  home setups, or ensuring safety with reliable surveillance
                  solutions, we deliver with precision, reliability, and care.
                </BodyText>
                <BodyText>
                  We don’t just provide services—we build lasting partnerships
                  grounded in trust, performance, and the pursuit of a smarter,
                  greener future.
                </BodyText>
